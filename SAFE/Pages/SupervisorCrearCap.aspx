    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td style="width: 385px; height: 72px;">
                <textarea id="txtDescripcionCap" rows="3" ></textarea>
            </td>
            <td style="height: 90px" class="auto-style2"></td>
            <td style="height: 90px" class="auto-style2"></td>
        </tr>
        <tr>
            <td class="auto-style2" style="height: 72px"></td>
            <td style="width: 150px; height: 72px;">
                <label for="date" title="" aria-setsize="">Expositor</label>                
            </td>
            <td style="width: 385px; height: 72px;" class="modal-sm">
                  <input type="text" id="txtExpositor" placeholder=" ">
            </td>
            <td class="auto-style2" style="height: 72px"></td>
            <td class="auto-style2" style="height: 72px"></td>
        </tr>
        <tr>
            ...
            <td style="width: 385px" class="modal-sm">
                <input type="date" id="fechaComienzo">
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 385px" class="modal-sm">
                <input type="text" id="txtMinParticipantes" placeholder=" ">
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
